...
const FXTradingDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <div className="relative w-full px-2 sm:px-3 lg:px-4 py-6">
        {/* Header */}
        ...
        {/* Tab Navigation */}
        <div className="flex gap-2 mb-8 p-1 bg-slate-800/50 rounded-xl border border-slate-700/50 backdrop-blur-sm w-full">
          <button
