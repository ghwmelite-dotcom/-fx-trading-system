...
CREATE TABLE IF NOT EXISTS trades (
    ...
    notes TEXT,
    tags TEXT, -- JSON array (e.g., '["scalping","trend-following"]')
    rating INTEGER CHECK(rating >= 1 AND rating <= 5), -- Overall trade rating (1-5 stars)
    ...
    emotions TEXT, -- JSON array (e.g., '["confident","patient"]')
